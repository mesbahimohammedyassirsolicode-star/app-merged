...
/**
 * Seeds the official TSGMP 1A timetable (EMPLOI FD Session 2 2024-2025 Site 4).
 * Filière: TSGMP, Group: 1A, Academic Year: 2024-2025, Session 2, Matin & Soir.
 */
class Tsgmp1ATimetableSeeder extends Seeder
{
    protected string $dataPath = 'database/data/tsgmp_1a_emploi_2024_2025_s2.json';
    ...
    public function run(): void
    {
        ...
        $this->command->info('Seeding TSGMP 1A timetable (2024-2025 Session 2)...');
        ...
        $this->command->info('TSGMP 1A timetable seeded successfully.');
    }
    ...
    private function ensureFiliere(Niveau $niveau, array $meta): Filiere
    {
        return Filiere::firstOrCreate(
            ...
            [
                ...
                'description' => 'Emploi du temps officiel Session 2 Site 4',
            ]
        );
    }
