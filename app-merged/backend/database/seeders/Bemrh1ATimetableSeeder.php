...
/**
 * Seeds the Bachelor Européen Management des Ressources Humaines (BEMRH) 1A timetable.
 * Filière: BEMRH, Group: 1A, Academic Year: 2024-2025, Session 2.
 * Template based on program brochure - update JSON with official emploi du temps when available.
 */
class Bemrh1ATimetableSeeder extends Seeder
{
    protected string $dataPath = 'database/data/bemrh_1a_emploi_2024_2025_s2.json';
    ...
    public function run(): void
    {
        ...
        $this->command->info('Seeding BEMRH 1A timetable (2024-2025 Session 2)...');
        ...
        $this->command->info('BEMRH 1A timetable seeded successfully.');
    }
    ...
    private function ensureFiliere(Niveau $niveau, array $meta): Filiere
    {
        return Filiere::firstOrCreate(
            ...
            [
                ...
                'description' => 'Bachelor Européen Management RH - Session 2',
            ]
        );
    }
