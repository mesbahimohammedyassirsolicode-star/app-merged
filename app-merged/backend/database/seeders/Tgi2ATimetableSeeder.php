...
/**
 * Seeds the official TGI 2A timetable (EMPLOI RAMADAN FD 2025-2026).
 * Filière: TGI, Group: 2A, Academic Year: 2025-2026, Session 2, Matin & Soir.
 */
class Tgi2ATimetableSeeder extends Seeder
{
    protected string $dataPath = 'database/data/tgi_2a_emploi_2025_2026_s2.json';
    ...
    public function run(): void
    {
        ...
        $this->command->info('Seeding TGI 2A timetable (2025-2026 Session 2)...');
        ...
        $this->command->info('TGI 2A timetable seeded successfully.');
    }
